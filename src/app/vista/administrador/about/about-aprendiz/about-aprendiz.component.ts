...
@Component({
  selector: 'app-about-aprendiz',
  templateUrl: './about-aprendiz.component.html',
  styleUrls: ['./about-aprendiz.component.css']
})
export class AboutAprendizComponent implements OnInit {
  ...
  aprendices=[
    ...
    {
      nombre:"Giovanny valderrama Perdomo",
      correo:"gvalderrama388@misena.edu.co",
      img:"/assets/img/fotos/valderrama3.jpg",
      equipo: "Back-end"
    },
    {
